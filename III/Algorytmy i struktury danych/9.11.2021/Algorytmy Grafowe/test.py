...
def Floyd_Warshall(polaczenia, ile_wierzcholkow, trasa_start, trasa_koniec):
	...
	for i in range(0, ile_wierzcholkow+1): # Pierwszy wiersz oraz kolumna są pomocnicze
	...
	print("Pierwsze wiersze i kolumny użyte w celach pomocniczych \nMacierz d: ")
	for i in d:
	...
	# Algorytm
	for u in range(1, ile_wierzcholkow+1): # Ignorujemy pierwszy wiersz i kolumnę bo jest użyta w celach pomocniczych
